...
type Whois struct {
	...
	Minbid string `protobuf:"bytes,5,opt,name=minbid,proto3" json:"minbid,omitempty"`
}
...
var fileDescriptor_ffb1e5b15fe01e48 = []byte{
	...
	,
}
...
func (m *Whois) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Minbid) > 0 {
		...
		i = encodeVarintWhois(dAtA, i, uint64(len(m.Minbid)))
		i--
		dAtA[i] = 0x2a
	}
	if len(m.Price) > 0 {
