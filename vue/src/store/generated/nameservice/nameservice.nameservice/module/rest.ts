...
export interface NameserviceQueryParamsResponse {
  ...
  params?: NameservicenameserviceParams;
}
 ...
 */
export type NameservicenameserviceParams = object;
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  ...
  queryNames = (
    ...
    this.request<NameserviceQueryNamesResponse, RpcStatus>({
      path: `/nameservice/nameservice/names`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
